...
| TraitEffectSelectEffectConfig;

export interface TraitEffectSelectEffectConfig {
  type: typeof EFFECT_TYPE.SELECT_EFFECT;
  effects: Exclude<TraitEffectConfig, TraitEffectSelectEffectConfig>[];
}
...
export interface TraitConfig extends BaseConfig {
  ...
  effects: [TraitEffectConfig] | [TraitEffectConfig, TraitEffectConfig];
}
